...
export const TenantDialog: React.FC<TenantDialogProps> = ({
  ...
  const title = editableTenant 
    ? (editableTenant.id ? `Edit Tenant: ${editableTenant.name}` : 'Add New Tenant') 
    : 'Tenant';
  
  const isSaveDisabled = !editableTenant || 
                         !editableTenant.name || 
                         !editableTenant.contact?.first_name || 
                         !editableTenant.contact?.last_name || 
                         !editableTenant.contact?.email;
